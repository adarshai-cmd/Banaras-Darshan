...
export default function CommunityPage() {
  return (
    <AuthGuard
      title="Traveler Community Chat"
      description="Sign in or create an account to join the Banaras Traveler Hub, chat with verified travelers, and share live Aarti crowd updates."
    >
